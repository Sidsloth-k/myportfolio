...
const SkillDetailModal: React.FC<SkillDetailModalProps> = ({
  ...
  if (!selectedSkill || !skillData) return null;
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background: `linear-gradient(135deg, ${skillData.color}, ${skillData.color}DD)`,
          }}
        >
          ...
          <div className="flex items-center justify-between relative z-10">
            <div className="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-white/30 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-white/20 flex-shrink-0">
                <skillData.icon className="w-6 h-6 sm:w-8 sm:h-8 text-white drop-shadow-lg" />
              </div>
              <div className="min-w-0 flex-1">
                ...
                <p className="text-white/95 text-sm sm:text-lg font-medium truncate">
                  {skillData.category} • {skillData.experience}
                </p>
              </div>
            </div>
          ...
          <div className="p-4 sm:p-6 space-y-6 sm:space-y-8 bg-dazai-cream dark:bg-card backdrop-blur-sm">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4">
                {skillData.technologies.map((tech: string, index: number) => (
                  <motion.div
                    key={tech}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                {skillData.projects.map((project: Project) => (
                  <motion.div
                    key={project.id}
